...
# =============================================================
#  check_status.sh
#  Run anytime to see a complete health snapshot of Aerobot.
#  No root needed.
#
#  Usage:
...
echo ""
echo "============================================================"
echo "  Aerobot — System Status"
echo "============================================================"

# ── Service status ────────────────────────────────────────
echo ""
echo "▶ SERVICE"
STATUS=$(systemctl --user is-active aerobot.service 2>/dev/null || echo "unknown")
ENABLED=$(systemctl --user is-enabled aerobot.service 2>/dev/null || echo "unknown")
echo "   Active  : $STATUS"
...
journalctl --user -u aerobot.service -n 10 --no-pager 2>/dev/null || \
    echo "   (no logs yet)"
...
echo ""
echo "▶ .ENV FILE"
ENV_PATH="/home/admin123/Desktop/Aerobot/.env"
if [ -f "$ENV_PATH" ]; then
...
echo "    journalctl --user -u aerobot.service -f"
echo "============================================================"
echo ""
